...
class REST:
    ...
    def sendTemplateSMS(self, to,datas,tempId):
        ...
        if self.BodyType=='xml':
            headers={"Authorization": auth,"Accept": "application/xml","Content-Type": "application/xml;charset=utf-8"}
        else:
        ...
        ret = yield tornado.gen.Task(req.fetch,
         url,
         method="POST",
         headers=headers,
         body=body,
        ...
        if self.Iflog:
            self.log(url,body,data)
        raise tornado.gen.Return(locations)
